#!/usr/bin/env bash
# POSIX Compatibility Layer - Build and upload to PyPI
set -e
cd "$(dirname "${BASH_SOURCE[0]}")"

PYTHON="${PYTHON:-python3}"
VERSION_FILE="src/posix_compat/__init__.py"
...
rm -rf dist/ build/ *.egg-info src/*.egg-info src/posix_compat.egg-info
